  ...
  return (
    <main className="site-shell">
      ...
      <section className="hero" id="top" aria-labelledby="hero-title">
        ...
        <div className="hero-copy"><p className="eyebrow hero-kicker"><span className="dot" /> Cape Town, South Africa <span>•</span> Available for junior roles</p><p className="hero-intro">Hello, I’m Rebecca —</p><h1 id="hero-title">Junior<br /><em>Web Developer</em></h1><p className="hero-typewriter" aria-live="polite"><span>{typewriterText}</span><i aria-hidden="true" /></p><p className="hero-summary">An emerging tech professional bringing creative, solution-based web development from a strong customer service foundation.</p><div className="hero-actions"><a className="button-primary" href="#work">View selected work <ArrowDownRight size={18} /></a><a className="button-outline hero-resume" href={CV_URL} target="_blank" rel="noreferrer" download>Download resume <Download size={16} /></a><a className="text-link" href="#about">My story <ArrowRight size={15} /></a></div><div className="hero-credentials"><span>Currently building through</span><strong>CAPACITI</strong><span>12-month programme</span></div></div>
